...
const Signup: React.FC = () => {
  ...
  const [gstOtpVerified, setGstOtpVerified] = useState(false);
  ...
  function gstinChange(e) {
    if (gstOtpVerified) setGstOtpVerified(false);
    ...
    setDisableGstVerifyWithOtpBtn(!text.match(pattern));
  }
  ...
  function emailChange(e) {
    ...
    setDisableEmailVerifyWithOtpBtn(!text.match(pattern));
  }
                ...
                <section className="signup-form">
                  ...
                  >
                    <IonGrid className="pb-0">
                        ...
                        <IonCol>
                          <IonList className="py-0">
                            ...
                            >
                              ...
                              <IonItem lines="none" className="full-width-fields input-item">
                                <IonInput
                      ...
                      <IonRow className="ion-align-items-end yoo">
                      ...
                      <IonRow>
                        <IonCol>
                          <IonList className="py-0">
                            <IonItem
                              lines="none"
                              className="password-signup input-item-labeled"
                            >
                              <IonLabel
                                className="fs-13 mb-9 label-sm"
                                position="stacked"
                        ...
                        <IonCol size="auto">
                          <IonItem>
                            ...
                            {/* <Controller
                                                        ...
                                                        control={control}
                                                        rules={{ required: { value: true, message: t("FIELD_REQUIRED") } }}
                                                        render={({ field: { onChange, value,onBlur } }) => <IonCheckbox                                                            
